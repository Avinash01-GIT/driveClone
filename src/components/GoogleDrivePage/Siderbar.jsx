...
import { FaComputer, FaGoogleDrive } from "react-icons/fa6";
  ...
  return (
    <div>
      <Modal open={modal} onClose={handleOnClose}>
        <Box className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96  bg-red-400 shadow-lg p-4 rounded-xl  outline-none dark:bg-[#131314] dark:text-[#fff]">
      ...
      <div className="flex lg:flex-row sm:flex-col">
        <div className="w-[20%] p-2">
          ...
          <div className="pl-5 flex flex-col gap-2 my-5 justify-center lg:my-5 sm:my-0">
            <Link to="/drive">
              <div className="siderBarLink">
